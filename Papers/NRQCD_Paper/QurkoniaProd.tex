...
In this paper, we calculate $\Jpsi$ production using NRQCD formalism.
...
Under NRQCD the cross-section for direct production of a resonance $H$ in a collision of particle $A$ and $B$ can 
be expressed in factorized form 
\begin{equation}
  \begin{split}
    E\frac{d^{3}\sigma^{ab\rightarrow cd}}{d^{3}p}(^{(2S+1)}L_{J}) = &\sum_{a,b}\int \int dx_a\,dx_b 
...
\begin{equation}
\begin{split}
%{\cal{M}}(\chi_{c0}[^3S_1]_{8}(1P))/m_{\charm}^2 &= (0.00187\pm 0.00025) GeV^3\;,
