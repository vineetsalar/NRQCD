...
\section{Results and Discussions}
 ...
 As discussed in the last section there are 2 free parameters for $J/\psi$, 
2 for $J/\psi$ and 1 for $\chi_{cJ}$ to be obtained from experiments. 
...
\end{equation}
 ...
 To fit the remaining 2 parameters we use the combined fit for the
...
\end{enumerate}
  Figures~\ref{Fig:LDMEJPsi}, \ref{Fig:LDMEJPsiCDF} and \ref{Fig:LDMEJPsiLHCb}
...
($p_{T}$). 
  Figure.~\ref{Fig:SigmaPsi} shows the differential production 
cross-section of prompt $\psi$(2S) as a function of transeverse momentum 
($p_{T}$). 
...
as function of transverse momentum compared with the measured data at LHC 
 ...
 The LDMEs are obtained by a combined fot of the LHC plus Tevatron data.
}
\label{Fig:LDMEPsi2S}
\end{figure}
