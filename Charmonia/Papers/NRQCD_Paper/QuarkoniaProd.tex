...
\begin{figure}
\includegraphics[width=0.49\textwidth]{Figures/Chic/Chic1_ATLAS_Fit.pdf}
\includegraphics[width=0.49\textwidth]{Figures/Chic/Chic2_ATLAS_Fit.pdf}
\caption{(Color online) The NRQCD calculations of production cross section 
of  $\chi_{c1}$ and $\chi_{c2}$ in p+p collisions at
$\sqrt{s}$ = 7.0 TeV as a function of transverse momentum. 
The Calculations are compared with the measured data by
ATLAS experiment at LHC~\cite{}. The $\chi_{c}$
color octet LDMEs are obtained by fitting this data. 
}
\label{Fig:LDMEChicCDF}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\textwidth]{Figures/Chic/Chic2Chic1_CMS_Fit.pdf}
\includegraphics[width=0.49\textwidth]{Figures/Chic/Chic2Chic1_LHCb_Fit.pdf}
...
$\sqrt{s}$ = 7.0 TeV as a function of transverse momentum. 
The Calculations are compared with the measured data by
CMS and LHCb experiments at LHC~\cite{}. The $\chi_{c}$
color octet LDMEs are obtained by fitting this data. 
}
\label{Fig:LDMEChicCDF}
\end{figure}
...
%along with different fitted components. 
...
the Tevatron and LHC data
%fitted values of color-singlet and color-octet cross-section components 
