...
%                  \langle M(Q\barQ([^3S_1]_{1})\rightarrow J/\psi)\rangle 
%                +  d\sigma(Q\barQ([^1S_0]_{8}))
%                  \langle M(Q\barQ([^1S_0]_{8})\rightarrow J/\psi)\rangle\\ 
%                &+  d\sigma(Q\barQ([^3S_1]_{8}))
%                  \langle M(Q\barQ([^3S_1]_{8})\rightarrow J/\psi)\rangle 
%                +  d\sigma(Q\barQ([^3P_0]_{8}))
%                  \langle M(Q\barQ([^3P_0]_{8})\rightarrow J/\psi)\rangle\\ 
%                &+  d\sigma(Q\barQ([^3P_1]_{8}))
%                  \langle M(Q\barQ([^3P_1]_{8})\rightarrow J/\psi)\rangle
%                +  d\sigma(Q\barQ([^3P_2]_{8}))
%                  \langle M(Q\barQ([^3P_2]_{8})\rightarrow J/\psi)\rangle
%                + \cdot\cdot\cdot  \;,
%\label{eq:dsigmaJ}
%\end{split}
%\end{equation}
...
%The wavefunction of $\chi_c$ states can be written as
%\begin{equation}
%\begin{split}
...
mesons. 
%The expressions for the short distance coefficients are given
...
the experiments. 
%The other source to $\psi(2S)$ production is from $B$ hadron decays and
% we call it "$\psi(2S)$ from $B$". The sum of the prompt $J/\psi$($\psi(2S)$) and $J/\psi$($\psi(2S)$) from $B$ will be called 
%"inclusive $J/\psi$($\psi(2S)$)".
...
%The relevant branching fractions are given in Table~\ref{table:CharmoniaBFs},
...
%We use values from ~\cite{Cho:1995ce,Cho:1995vh,Eichten:1994gt},
%\begin{equation}
%\begin{split}
...
%The total squared amplitudes for creating 
