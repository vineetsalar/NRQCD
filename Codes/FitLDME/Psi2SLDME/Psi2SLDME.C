...
void Psi2SLDME()
{
  ...
  */
  ...
  Comb_lgd_CDF_196TeV_DSigmaDPtDY_Pt1->SetHeader("pp #surds=1.96 TeV, Prompt #psi(2S), |y^{#psi(2S)}| #leq 0.6");
  ...
  */
  ...
  Comb_lgd_CDF_180TeV_DSigmaDPtDY_Pt1->SetHeader("pp #surds=1.8 TeV, Prompt #psi(2S), |y^{#psi(2S)}| #leq 0.6");
