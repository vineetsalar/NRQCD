...
void Psi2SLDME()
{
  ...
  TF1 *CMSFitFunctionLDME = new TF1("CMSFitFunctionLDME", CMS_FitLDME, 5.0, 100, 2);
  CMSFitFunctionLDME->SetLineColor(2);

  //  0       1     2      3       4     5
  // 3S1_1, 1S0_8, 3S1_8, 3P0_8, 3P1_8, 3P2_8
  //CMSFitFunctionLDME->FixParameter(0,1);                         
  CMSFitFunctionLDME->SetParameter(0,0.0080);                         
  CMSFitFunctionLDME->SetParameter(1,0.0033);                          
  
  //FitFunctionLDME->SetParameter(3,0.0080*mC*mC);                    
  //FitFunctionLDME->SetParameter(4,3.0*0.0080*mC*mC);                    
  //FitFunctionLDME->SetParameter(5,5.0*0.0080*mC*mC);                    
  ...
  */
  ...
  mg->Fit("CMSFitFunctionLDME","Q0","MER", 5, 20);
  
  Double_t CMS_LDME_1S0_8 = CMSFitFunctionLDME->GetParameter(0);
  Double_t CMS_LDME_3S1_8 = CMSFitFunctionLDME->GetParameter(1);
  
  Double_t CMS_LDME_3S1_1 = 1.0;
  ...
  TF1 *CDFFitFunctionLDME = new TF1("CDFFitFunctionLDME", CDF_FitLDME, 5.0, 30, 2);
  ...
  Double_t CDF_LDME_3S1_1 = 1.0;
  Double_t CDF_LDME_1S0_8 = CDFFitFunctionLDME->GetParameter(0);
  Double_t CDF_LDME_3S1_8 = CDFFitFunctionLDME->GetParameter(1);
  ...
  TGraph *Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3S1_1_Fit=Scale_QCDSigma(grCDF_RootS196TeV_DSigmaDPtDY_Pt_3S1_1_Fit, CMS_LDME_3S1_1);
  Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3S1_1_Fit->SetLineColor(1);
  TGraph *Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_1S0_8_Fit=Scale_QCDSigma(grCDF_RootS196TeV_DSigmaDPtDY_Pt_1S0_8_Fit, CMS_LDME_1S0_8);
  Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_1S0_8_Fit->SetLineColor(4);
  TGraph *Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3S1_8_Fit=Scale_QCDSigma(grCDF_RootS196TeV_DSigmaDPtDY_Pt_3S1_8_Fit, CMS_LDME_3S1_8);
  Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3S1_8_Fit->SetLineColor(6);
  TGraph *Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3P0_8_Fit=Scale_QCDSigma(grCDF_RootS196TeV_DSigmaDPtDY_Pt_3P0_8_Fit, CMS_LDME_3P0_8);
  Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3P0_8_Fit->SetLineColor(8);
  TGraph *Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3P1_8_Fit=Scale_QCDSigma(grCDF_RootS196TeV_DSigmaDPtDY_Pt_3P1_8_Fit, CMS_LDME_3P1_8);
  Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3P1_8_Fit->SetLineColor(9);
  TGraph *Out_grCDF_RootS196TeV_DSigmaDPtDY_Pt_3P2_8_Fit=Scale_QCDSigma(grCDF_RootS196TeV_DSigmaDPtDY_Pt_3P2_8_Fit, CMS_LDME_3P2_8);
  ...
  TF1 *LHCbFitFunctionLDME = new TF1("LHCbFitFunctionLDME", LHCb_FitLDME, 5.0, 30, 2);
  LHCbFitFunctionLDME->SetLineColor(2);

  //  0       1     2      3       4     5
  // 3S1_1, 1S0_8, 3S1_8, 3P0_8, 3P1_8, 3P2_8
  //LHCbFitFunctionLDME->FixParameter(0,CMS_LDME_1S0_8);   
  //LHCbFitFunctionLDME->FixParameter(1,CMS_LDME_3S1_8);   

  grfData_LHCb_D2NDPtDy_PromptPsi2S_Y2045_Pt->Fit("LHCbFitFunctionLDME","Q0","MER", 5, 20);
  
  Double_t LHCb_LDME_3S1_1 = 1.0;
  Double_t LHCb_LDME_1S0_8 = LHCbFitFunctionLDME->GetParameter(0);
  Double_t LHCb_LDME_3S1_8 = LHCbFitFunctionLDME->GetParameter(1);
  ...
  gr2=Data_CDF_196_D2NDPtDy_PromptPsi2S_Y0006_Pt();

  gr3=new TGraphAsymmErrors(); 
  gr3=Data_LHCb_D2NDPtDy_PromptPsi2S_Y2045_Pt();
  ...
  static Double_t vstart[] = {0.0080,0.0033};
  static Double_t step[]   = {0.00001 , 0.00001};


  gMinuit->mnparm(0, "1S0_8", vstart[0], step[0], 0, 0, ierflg);
 ...
 Int_t i = 0;
  ...
  TF1 *fun_2=new TF1("fun_2",CDF_FitLDME, 4.0, 30, 3);
  ...
  TF1 *fun_3=new TF1("fun_2",LHCb_FitLDME, 4.0, 30, 3);
  ...
  cout<<"LDME : 1S0_8 "<<currentPar[0]<<endl;
  cout<<"LDME : 3S1_8 "<<currentPar[1]<<endl;
...
{ 
 ...
 //calculate chisquare
  ...
  for (i=0;i<  nbins; i++) {
    ...
    Double_t delta  = (yy2[i]-CDF_FitLDME(&xx2[i],par))/erryy2[i];
    chisq += delta*delta;
  }
  return chisq;
}
...
{ 
 ...
 //calculate chisquare
  ...
  for (i=0;i<nbins; i++) {
    //Double_t delta  = (y2[i]-myFunc_2(&x2[i],par))/ey2[i];
    Double_t delta  = (yy3[i]-LHCb_FitLDME(&xx3[i],par))/erryy3[i];
    chisq += delta*delta;
  }
  return chisq;
}
...
TGraphAsymmErrors *Data_LHCb_D2NDPtDy_PromptPsi2S_Y2045_Pt()
{
  ...
  Double_t p8319_d1x1y1_yerrminus[NN] = {6,8,7,6,4,2,1,1,1,0.4,0.3,0.1};
  Double_t p8319_d1x1y1_yerrplus[NN] = {6,8,7,6,4,2,1,1,1,0.4,0.3,0.1};
